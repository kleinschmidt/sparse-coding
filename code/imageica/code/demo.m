...
switch exnum,
 ...
 case 3,
  ...
  p.stepsize = 0.1;
  p.epsi = 0.005;
  estimate( whiteningMatrix, dewhiteningMatrix, '../results/tica_s.mat', p );
 ...
 case 9,
  ...
  p.stepsize = 0.1;
  p.epsi = 0.005;
  estimate_tica( whiteningMatrix, dewhiteningMatrix, '../results/tica_f.mat', p );

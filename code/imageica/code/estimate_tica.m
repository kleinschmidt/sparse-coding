function estimate_tica( whiteningMatrix, dewhiteningMatrix, fname, p )

% estimate_tica - algorithms for topographic ICA
%
% SYNTAX:
% estimate_tica( whiteningMatrix, dewhiteningMatrix, fname, dims );
%
